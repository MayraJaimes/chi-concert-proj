...
function addVenues() {
	...
	for (venue in venueID){
		...
		newVenueDiv += `<div class="col-xs-12 col-sm-6 col-md-4"><div class="card">
		 <a href="venues.html?venue=${event.id}"> <div class="card-img-top homepageIMG" style="background-image: url(assets/images/${event.id}.jpg)"></div></a>
		  <div class="card-body">
